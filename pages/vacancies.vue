<template>
  <div class="about">
    ...
    <div class="vac">
      ...
      <div class="vac_docs">
        <div class="vac_docs_download">
          ...
          <a href="https://marketbot.abelsharman.kz/anketa.doc" download
          ...
          <div class="flex h-screen items-center justify-center text-center">
            ...
            >
              <input
                ...
                @change="onChange"
                ref="file"
                accept=".pdf,.jpg,.jpeg,.png,.docs,.docx,.doc"
              />
      ...
      <div class="vac_list">
        ...
        >
          ...
          <a
            href="https://marketbot.abelsharman.kz/anketa.doc"
            ...
            ><v-btn
              ...
              <img
                src="../assets/pdf.png"
                style="margin-left: 0.8vw; width: 3.4vw; margin-top: 0.5vw"
                alt="" /></v-btn
          ></a>
          <v-btn
            color="primary"
            @click="(popupMobile = true), (example = item.nameVac)"
            style="
              font-size: 3.2vw;
              letter-spacing: 0.03em;
              width: 48vw;
              ...
              font-family: 'Montserrat', sans-serif;
            "
            >Отправить анкету</v-btn
          >
          <div
            style="width: 100%; height: 1px; background-color: #c4c4c4"
          ></div>
        </div>
      </div>
    </div>
    ...
    <v-dialog v-model="popup" class="dialog_desktop" width="600">
...
export default {
  ...
  data() {
    return {
      ...
      countItems: [
        ...
        "10 вакансий на странице",
        "15 вакансий на странице",
  ...
  methods: {
    ...
    onChange() {
      ...
      this.$axios
        .post("https://crewing.kz/upload", formData)
        .then((res) => {
          console.log(res);
          alert("Отправлено");
        })
