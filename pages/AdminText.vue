    ...
    <div class="admintext">
        ...
        <div v-if="!loading" style="padding-top: 20vh; padding-left:4vw;">
            <div style="display:inline-block;width: 45vw;">
                <v-textarea label="Телефон" filled style="width: 40vw;" v-model="phone"></v-textarea>
                <v-textarea label="Первый текст в блоке 'О нас'" filled style="width: 40vw;" v-model="about_1"></v-textarea>
                <v-textarea label="Второй текст в блоке 'О нас'" filled style="width: 40vw;" v-model="about_2"></v-textarea>
                <v-textarea label="Цитата в блоке 'О нас'" filled style="width: 40vw;" v-model="about_3"></v-textarea>
                <v-textarea label="Текст над картинкой в блоке 'О нас'" filled style="width: 40vw;" v-model="about_4"></v-textarea>
                <v-textarea label="Первый текст в блоке 'Обучение'" filled style="width: 40vw;" v-model="education_1"></v-textarea>
                <v-textarea label="Второй текст в блоке 'Обучение'" filled style="width: 40vw;" v-model="education_2"></v-textarea>
                <v-textarea label="Количество типов судов" filled style="width: 40vw;" v-model="count_type"></v-textarea>
                <v-textarea label="Количество сотрудников" filled style="width: 40vw;" v-model="people_count"></v-textarea>
                <v-textarea label="Текст для навигаций на страницу Судна" filled style="width: 40vw;" v-model="nav_to_sudna"></v-textarea>
            </div>
...
export default {
    ...
    methods:{
        ...
        changeData(){
            ...
            this.$axios.patch("https://periodicals.abelsharman.kz/crewingData", obj)
            .then((res)=>{
                // this.vacancies.splice(1, 8);
                console.log(res)
            })
