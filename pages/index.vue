<template>
  <div class="main_page">
    ...
    <div class="home" v-if="!loading" id="home123">
      ...
      <p id="p1" v-scroll-to="{ el: '#about', offset: -100 }" class="home_1">
        a
      </p>
    ...
    <div class="home_mobile">
      <p style="text-transform: uppercase">
        Трудоустройство морского персонала
      </p>
      <v-btn
        depressed
        color="primary"
      ...
      <img
        class="home_mobile_down"
        v-scroll-to="{ el: '#footer', offset: -100 }"
        src="../assets/down.png"
        alt=""
      />
    ...
    <div class="vac" id="vac">
      ...
      <div
        class="vac_list_item"
        v-for="(item, index) in vacancies.slice(0, 2)"
        :key="index"
      >
    ...
    <div class="vac_mobile">
      ...
      <div
        class="vac_mobile_card"
        v-for="(item, index) in vacancies.slice(0, limit)"
        :key="index"
      >
        <div class="vac_mobile_card_name">
          <h1>
            {{ item.nameVac }} | <span> {{ item.count }} позиции</span>
          </h1>
          <p>{{ item.text }}</p>
        </div>
        ...
        <div class="vac_mobile_card_dop">
          ...
          <h2 class="vac_mobile_card_dop_price">
            Заработная плата: <span>{{ item.price }}</span>
          </h2>
        </div>
      </div>
      ...
      <div class="cert_img">
        <div>
          ...
          <picture>
            ...
            <img
              @click="changeAnotherImage($event.target)"
              style="left: 0vw"
              class="cert_img_upd"
              src="../assets/slide1upd.png"
              alt=""
            />
          </picture>
        </div>
    ...
    <div class="count_mobile">
      ...
      <span
        style="margin-top: 6vw; display: inline-block"
        class="count_numb_2"
        id="d"
        >{{ people_count }}</span
      >
    ...
    <div class="feedback_mobile">
      ...
      >
        <template v-slot:label style="color: white; border: 0px">
          <div style="color: white; border: 0px">Имя</div>
        </template>
      </v-text-field>
      <v-text-field
        label="Телефон"
      ...
      >
        <template v-slot:label style="color: white; border: 0px">
          <div style="color: white; border: 0px">Телефон</div>
        </template>
      </v-text-field>
      <v-btn
        style="
    ...
    <Footer id="footer" />
    <v-dialog v-model="popup" width="600">
  ...
  methods: {
    ...
    animateValue(obj, start, end, duration) {
      ...
      const step = (timestamp) => {
        ...
        const progress =
          Math.min((timestamp - startTimestamp) / duration, 1) / 10;
    ...
    changeImage(event) {
      ...
      event.parentNode.parentNode.childNodes[2].childNodes[2].style.transform =
        "rotateY(0deg)";
    },
    changeAnotherImage(event) {
      event.style.transform = "rotateY(90deg)";
      event.parentNode.parentNode.childNodes[0].childNodes[2].style.transform =
        "rotateY(0deg)";
    },
  },
  components: {
